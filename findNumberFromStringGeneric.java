...
public class findNumberFromStringGeneric {
    ...
    /*
    stringToNumber prints the number of the selected string
    in the sequence of strings that can be generated by the chosen alphabet.
     */
    ...
    /*
    findValue returns the position of the symbol in the alphabet
     */
